  ...
  return (
    <Container>
      <div className="flex justify-between items-center py-6 font-Inter">
        ...
        <Link
          to="/book-a-call"
          className="bg-primary-10 hover:bg-gradient-to-r  hover:from-[#FDEBE7]/30 hover:to-primary-10 ease-in-out text-white text-[24px] px-6 py-2 rounded-[36px] shadow transition duration-300"
